...
extern uint8_t cmdsequence;
// > 10 words in a metadata, but we'll stop at Q point 3
extern unsigned int metaData[MAX_METADATA_SIZE];
//These are the raw sensor values pulled from the user requested Input Report
extern uint16_t rawAccelX, rawAccelY, rawAccelZ, accelAccuracy;
extern uint16_t rawLinAccelX, rawLinAccelY, rawLinAccelZ, accelLinAccuracy;
extern uint16_t rawGyroX, rawGyroY, rawGyroZ, gyroAccuracy;
extern uint16_t rawMagX, rawMagY, rawMagZ, magAccuracy;
extern uint16_t rawQuatI, rawQuatJ, rawQuatK, rawQuatReal, rawQuatRadianAccuracy, quatAccuracy;
extern uint16_t stepCount;
extern uint8_t stabilityClassifier;
extern uint8_t activityClassifier;
extern uint8_t *_activityConfidences; //Array that store the confidences of the 9 possible activities
extern uint8_t calibrationStatus; //Byte R0 of ME Calibration Response
//These Q values are defined in the datasheet but can also be obtained by querying the meta data records
//See the read metadata example for more info
extern int16_t rotationVector_Q1;
extern int16_t accelerometer_Q1;
extern int16_t linear_accelerometer_Q1;
extern int16_t gyro_Q1;
extern int16_t magnetometer_Q1;
/* ------------------------------------------------------------ *
